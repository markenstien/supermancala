...
--
-- Table structure for table `common_transactions`
--
...
--
-- Indexes for table `common_transactions`
--
ALTER TABLE `common_transactions`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `common_transactions`
--
ALTER TABLE `common_transactions`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
